...
*/
  ...
  playAnimation(isFiring){
    if(this.activatedJet){
      ...
      this.movingArm.anims.timeScale = 1;
      if(!this.isTakingOf){
        if(this.cursors.down.isDown){
      ...
      if(this.sprite.body.velocity.y < 2){
        if(this.cursors.right.isDown || this.cursors.left.isDown){
          this.sprite.anims.timeScale = this.playerMoveForceX();            //hay que clampear
          this.movingArm.anims.timeScale = this.playerMoveForceX();         //hay que clampear
